          ...
          <div>
            <div className="space-y-5 sm:p-16 pb-6">
              ...
              <p data-aos="fade-up" className="leading-8 tracking-wide">
                "Joining this gym was a game-changer! The trainers are
                top-notch, the equipment is state-of-the-art, and the atmosphere
                is always motivating. I've never felt better about my fitness
                journey."
              </p>
